...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/equilibrator-cache-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11109&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/equilibrator-cache-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `equilibrator-cache` can be installed with:

```
conda install equilibrator-cache
```

It is possible to list all of the versions of `equilibrator-cache` available on your platform with:
